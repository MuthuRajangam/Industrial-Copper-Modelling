...
st.sidebar.header(":orange[COPPER] :violet[MODELLING]")

options = st.sidebar.radio(("Pick your option"),("HOME","PREDICTIONS" ) )
...
if options == "HOME":
    ...
    st.write("-------------------") 
    st.caption("## :blue[Domain] : Manufacturing")
    st.caption("## :blue[Technologies used] : Python, Numpy, Pandas, Data Preprocesing,EDA, Streamlit")
    st.caption("## :blue[Overview] : To analyze the selling price details and prediction of the status which was WON or LOST with the given data set of industrial copper modelling project.")
...
if options == "PREDICTIONS":
    ...
    with tab1:    
            ...
            if submit_button and flag==0:
                ...
                import pickle
                with open ("C:\\Users\\ADMIN\\Downloads\\vscode\\model.pkl", 'rb') as file:
                    loaded_model = pickle.load(file)
                with open ("C:\\Users\\ADMIN\\Downloads\\vscode\\scaler.pkl", 'rb') as f:
                    scaler_loaded = pickle.load(f)
                with open ("C:\\Users\\ADMIN\\Downloads\\vscode\\t.pkl", 'rb') as f:
                    t_loaded = pickle.load(f)
                with open ("C:\\Users\\ADMIN\\Downloads\\vscode\\s.pkl", 'rb') as f:
    ...
    with tab2: 
            ...
            if csubmit_button and cflag==0:
                ...
                with open("C:\\Users\\ADMIN\\Downloads\\vscode\\cmodel.pkl",'rb') as file:
                    cloaded_model = pickle.load(file)
                with open("C:\\Users\\ADMIN\\Downloads\\vscode\\cscaler.pkl",'rb') as f:
                    cscaler_loaded = pickle.load(f)
                with open("C:\\Users\\ADMIN\\Downloads\\vscode\\ct.pkl",'rb') as f:
